...
# 执行你的任务命令
CUDA_VISIBLE_DEVICES=4 python3 /home/zsm/code/0-qwen-image-finetune-ori/tests/7_qwen_lora_attentionloss_f9b1_mask.py > /home/zsm/code/qwen-image-finetune/configs/logs/f9b1.log 2>&1 
wait
echo "all end!"